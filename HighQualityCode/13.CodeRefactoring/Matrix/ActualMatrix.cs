...
namespace Matrix
{
    public class ActualMatrix
    {
        ...
        public ActualMatrix(int dimensions)
        {
        ...
        public int Dimensions
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Dimensions value can only be between 1 and 100!");
                }
        ...
        private void FindAvailableCell()
        {
            ...
            for (int currRow = 0; currRow < this.dimensions; currRow++)
            {
                for (int currCol = 0; currCol < this.dimensions; currCol++)
                {
