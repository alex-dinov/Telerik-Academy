    ...
    public class FigureController
    {
        ...
        protected virtual void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                ...
                case "area":
                    {
                        IAreaMeasurable current = this.currentFigure as IAreaMeasurable;
                        if (current != null)
                        {
                            Console.WriteLine("{0:0.00}",current.GetArea());
                        }
                        else
                        {
                ...
                case "volume":
                    {
                        IVolumeMeasurable current = this.currentFigure as IVolumeMeasurable;
                        if (current != null)
                        {
                            Console.WriteLine("{0:0.00}",current.GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "normal":
                    {
                        IFlat current = this.currentFigure as IFlat;
                        if (current != null)
                        {
                            Console.WriteLine("{0:0.00}", current.GetNormal());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
